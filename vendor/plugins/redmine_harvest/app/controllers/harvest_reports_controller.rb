class HarvestReportsController < ApplicationController
  ...
  private
    ...
    def retrieve_date_range
      ...
      @from ||= (HarvestTime.minimum(:spent_at, :include => :project, :conditions => Project.allowed_to_condition(User.current, :view_time_entries)) || Date.today).to_date - 1
      @to   ||= (HarvestTime.maximum(:spent_at, :include => :project, :conditions => Project.allowed_to_condition(User.current, :view_time_entries)) || Date.today).to_date
    end
end
